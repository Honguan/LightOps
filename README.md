...
```bash
curl -fsSL https://raw.githubusercontent.com/<owner>/lightops/main/install.sh | sudo bash
...
```bash
curl -fsSL https://raw.githubusercontent.com/<owner>/lightops/main/install.sh -o install.sh
